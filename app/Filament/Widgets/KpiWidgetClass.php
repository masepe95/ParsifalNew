...
class KpiWidgetClass extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        return [
            Stat::make('Mansioni Ricercate dai Candidati', '$' . $formatNumber($revenue))
                ->description('32k increase')
                ->descriptionIcon('heroicon-m-arrow-trending-up')
                ->chart([7, 2, 10, 3, 15, 4, 17])
                ->color('success'),
            Stat::make('Mansioni Ricercate dalle Aziende', $formatNumber($newCustomers))
